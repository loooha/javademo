...
public class Java216_thread {
	...
	public static void main(String[] args) {
		...
		FamilyThraed father = new FamilyThraed(wr, "father");
		FamilyThraed mather = new FamilyThraed(wr, "mather");
		FamilyThraed sister = new FamilyThraed(wr, "sister");
		FamilyThraed brother = new FamilyThraed(wr, "brother");
