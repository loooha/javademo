...
public class Java144_Wrapper {
	...
	public static void main(String[] args) {
		...
		// 크키 차이로 auto unboxing이 안됨 - auto casting이 발생될 때만 가능
		// int x2 = de; // 더 작은 값으로는 오토언박싱 되지않음.
		// int x2 = (int)de; // (int)de는 기본데이터 타입일때만 가능한데, de는 현재 객체이기때문에 불가능
