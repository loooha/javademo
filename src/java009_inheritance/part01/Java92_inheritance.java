...
/*
 * 상속(Inheritance)
 *  : 기본 클래스가 가지고 있는 멤버들을 새로 만들 크래스에서 직접 만들지 않고
 ...
 * 		상속을 받는 클래스 : 서브클랙스(sub), 자식클래스, 유도클래스
 * 4. 자식(손)의 조상의 모든 자원을 상속받는다. (생성자, static{ }은 제외)
 * 5. 자식(손)의 자원은 부모보다 크거나 같아야 한다.
 * 6. 상속을 할때 사용되는 키워드 : 
 * 		클래스에 클래스를 상속 : extends(단일상속), 인터페이스에 인터페이스 상속 : extends(다중상속)
 * 		
 * 		class A{ }
 * 		class B extends A{ }
...
public class Java92_inheritance {
	public static void main(String[] args) {
		...
		// c멤버변수는 private이 선언되어 있기 때문에 상속이 안된다.
